...
import { setupRouter, whenRouteIdle } from '../scheduler.js';
...
class RouterScroll extends Service {
  ...
  static {
    n(this.prototype, "_routeWillChange", [action]);
  }
  ...
  static {
    n(this.prototype, "_routeDidChange", [action]);
  }
  unsetFirstLoad() {
...
export { RouterScroll as default };
//# sourceMappingURL=router-scroll.js.map
